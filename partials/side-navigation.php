<nav class="off-canvas position-right" id="offCanvasRight" data-off-canvas="" data-position="right" aria-hidden="false">
	<ul class="menu vertical side-nav" itemscope itemtype="http://schema.org/SiteNavigationElement">
		...
		<li><a href="/riddelphotographers/families/" class="animsition-link">Families</a></li>
		<li><a href="/riddelphotographers/personal/" class="animsition-link">Personal</a></li>
		<li><a href="/riddelphotographers/pricing.php" class="animsition-link">Pricing</a></li>
		<li><a href="/riddelphotographers/contact.php" class="animsition-link">Contact</a></li>
	</ul>
</nav>