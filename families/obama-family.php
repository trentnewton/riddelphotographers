...
<html class="no-js" lang="en">
  <head>
    ...
    <title>Obama Family || Riddel Photographers</title>
        ...
        <?php include("../partials/gallery-header.php"); ?>
          <main class="gallery-page">
            <div class="row">
              <div class="column">
                <header class="gallery-page-header-container">
                  <h1 class="gallery-page-header">Obama Family</h1>
                </header>
                <div class="content">
            ...
            <div class="grid">
              ...
              <div class="grid-item">
                <img src="/riddelphotographers/uploads/families/11/IMG_4396(pp_w858_h573).jpg" alt="img01" />
              </div>
              <div class="grid-item">
                <img src="/riddelphotographers/uploads/families/11/IMG_4495(pp_w858_h573).jpg" alt="img02" />
              </div>
              <div class="grid-item">
                <img src="/riddelphotographers/uploads/families/11/IMG_4562(pp_w858_h573).jpg" alt="img03" />
              </div>
              <div class="grid-item">
                <img src="/riddelphotographers/uploads/families/11/IMG_4589.jpg" alt="img03" />
              </div>
              <div class="grid-item">
                <img src="/riddelphotographers/uploads/families/11/IMG_4620(pp_w858_h573).jpg" alt="img04" />
              </div>
              <div class="grid-item">
                <img src="/riddelphotographers/uploads/families/11/IMG_4675(pp_w858_h573).jpg" alt="img05" />
              </div>
              <div class="grid-item">
                <img src="/riddelphotographers/uploads/families/11/IMG_4677.jpg" alt="img05" />
              </div>
            </div>
          </main>
